  ...
  return (
    <div className={isMobile? "sidebarMobile" : isCollapsed ? "sidebarCollapsed" : "sidebar"}>
      <ul className={ isCollapsed ? "Nav-collapsed" : "Nav" } >      
        ...
        <li className={ isCollapsed ? "li-collapsed" : "li"} onClick={handleClickProjects}>Gaming Hub</li>
        <li className={ isCollapsed ? "li-collapsed" : "li"} onClick={handleClickProjects}>Art Gallery</li>
